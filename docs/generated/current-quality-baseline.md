...
Scanned 423 source files, 121214 physical lines, and 112804 nonblank lines.
...
| `rust_json_value_mentions` | 1173 |
| `rust_panic_macros` | 316 |
| `rust_sleep_calls` | 58 |
| `rust_spawn_calls` | 72 |
| `rust_unsafe_tokens` | 43 |
| `rust_unwrap_calls` | 1983 |
...
| `modules/storage-legacy/src/tests.rs` | 2516 |
