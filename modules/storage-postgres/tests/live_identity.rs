...
fn live_identity_storage_passes_conformance() {
    ...
    aseman_ports::conformance::grant_store(
        &aseman_capsule_repositories::capability::CapsuleGrantStore {
            repository: &repository,
        },
    );
    aseman_ports::conformance::decision_audit(
        &aseman_capsule_repositories::audit::CapsuleDecisionAudit {
            repository: &repository,
        },
    );
