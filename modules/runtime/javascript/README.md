...
`modules/runtime/wasm/src/host_calls.rs`**, because a creature should not be able to tell
...
src/host_calls.rs   the op table (keep in step with modules/runtime/wasm)
