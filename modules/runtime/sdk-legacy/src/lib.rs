...
//!
//! A VM type is a standalone Rust project living under `modules/runtime/` that:
//!
...
//!
//! At node build time the Aseman CLI (`asemanctl vms sync`) scans the runtime
//! folder and generates a compatibility aggregation crate that imports every
